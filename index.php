...
<body>
  ...
  <section class="hero-section">
    <div class="hero-container">
      <div class="hero-content">
        ...
        <h1>আপনার নিজস্ব নিউজ পোর্টাল তৈরি করুন মাত্র কয়েক মিনিটে!</h1>
  ...
  <section class="cta-section">
    <div class="cta-card">
      ...
      <p>ফ্রি রেজিস্ট্রেশন করুন এবং মাত্র কয়েক মিনিটে আপনার নিজস্ব নিউজ পোর্টাল চালু করুন।</p>
      <div class="btn-group">
        <a href="register.php" class="btn-primary">
          <i class="fas fa-user-plus"></i> ফ্রি রেজিস্ট্রেশন
        </a>
        <a href="Admin/index.php" class="btn-secondary">
          <i class="fas fa-sign-in-alt"></i> অ্যাডমিন লগইন
        </a>
