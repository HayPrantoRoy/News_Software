    ...
    <section class="hero-style-section">
        ...
        <div class="hero-style-layout grid-layout">
            ...
            <div class="hero-style-main-article">
                <a href="news.php?path=<?= urlencode($midNews[0]['category_slug'] . '/' . $midNews[0]['slug']); ?>">
                    <img src="Admin/img/<?= htmlspecialchars($midNews[0]['image_url']); ?>" alt="<?= htmlspecialchars($midNews[0]['headline']); ?>">
                </a>
                <div class="content">
                    <h3><a href="news.php?path=<?= urlencode($midNews[0]['category_slug'] . '/' . $midNews[0]['slug']); ?>"><?= htmlspecialchars($midNews[0]['headline']); ?></a></h3>
            ...
            <div class="hero-style-main-article">
                <a href="news.php?path=<?= urlencode($midNews[1]['category_slug'] . '/' . $midNews[1]['slug']); ?>">
                    <img src="Admin/img/<?= htmlspecialchars($midNews[1]['image_url']); ?>" alt="<?= htmlspecialchars($midNews[1]['headline']); ?>">
                </a>
                <div class="content">
                    <h3><a href="news.php?path=<?= urlencode($midNews[1]['category_slug'] . '/' . $midNews[1]['slug']); ?>"><?= htmlspecialchars($midNews[1]['headline']); ?></a></h3>
            ...
            <div class="hero-style-sidebar">
                ...
                <div class="hero-style-sidebar-item">
                    <a href="news.php?path=<?= urlencode($midNews[$j]['category_slug'] . '/' . $midNews[$j]['slug']); ?>">
                        <img src="Admin/img/<?= htmlspecialchars($midNews[$j]['image_url']); ?>" alt="<?= htmlspecialchars($midNews[$j]['headline']); ?>">
                    </a>
                    <div class="content">
                        <h4><a href="news.php?path=<?= urlencode($midNews[$j]['category_slug'] . '/' . $midNews[$j]['slug']); ?>"><?= htmlspecialchars($midNews[$j]['headline']); ?></a></h4>
                    </div>
                </div>
                <?php endfor; ?>
            </div>
