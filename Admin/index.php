...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_login'])) {
    ...
    if ($password === $user['password']) {
        ...
        $_SESSION['username'] = $user['number']; // Use number as username
        $_SESSION['role_name'] = 'Super Admin';
        $_SESSION['is_super_admin'] = true; // Master users are super admins
...
if (isset($_GET['logout'])) {
    // Clear localStorage via JavaScript before destroying session
    echo "<script>
...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>সংবাদ প্রশাসন প্যানেল</title>
...
<body>
    ...
    @media (max-width: 576px) {
        ...
        .nav-menu { width: 250px; padding: 70px 15px 20px; }
    }
    </style>
    <script>
        (function() {
...
@media (max-width: 480px) {
        ...
        <div class="section">
            <div class="section-header">
                ...
                <button class="btn btn-primary" onclick="loadNews()" style="padding: 6px 10px; background: none; border: none; box-shadow: none;">
                    <img src="icons/refresh-button.png" alt="রিফ্রেশ" title="রিফ্রেশ" style="width:28px;height:28px;vertical-align:middle;display:inline-block;">
                </button>
            </div>
            ...
            <div class="filters modern-filters">
                <div class="filter-row">
                    ...
                    <div class="filter-actions">
                        <img src="icons/searchbackground.png" alt="ফিল্টার" class="icon-btn" id="filter-btn" title="ফিল্টার" onclick="applyFilters()">
                        <img src="icons/rubber.png" alt="পরিষ্কার" class="icon-btn" id="clear-btn" title="পরিষ্কার" onclick="clearFilters()">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        async function handleFormSubmit(e) {
            ...
            // Editors automatically sync with tetareas, but ensure it's done
            ['news_1', 'news_2', 'news_3', 'news_4'].forEach(function(id) {
                if (editors[id]) {
...
async function viewNews(id) {
    try {
        ...
        if (news.image_url) {
            html += `<img class='news-view-img' src='img/${news.image_url}' alt='Main Image' onerror="this.style.display='none'">`;
        }
